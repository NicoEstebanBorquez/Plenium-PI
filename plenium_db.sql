...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-05-2022 a las 13:25:59
...
(60, '2022-05-08', 'Ático dúplex de 4 dormitorios', 'ÁTICO', 265000, 126, 135, 'Avda. Mediterráneo nº 32 - 4ºB', 'Nerja', 'Málaga', 4, 3, NULL, 'si', 'si', NULL, NULL, NULL, 'si', 'si', 'si', 'si', 'si', NULL, 'Lorena', 'Montiel Pazos', '36524965H', '693258741', 'montiel.pazos@mail.com', NULL, 1),
...
(62, '2022-05-13', 'Piso de 2 dormitorios con parking', 'PISO', 168000, 85, 93, 'Avda. Del Sol nº 19 - Portal 2 - 4ºF', 'Málaga', 'Málaga', 2, 2, 'si', 'si', 'si', NULL, 'si', NULL, 'si', 'si', 'si', 'si', 'si', NULL, 'Lucía', 'Martínez Prado', '25753148E', '685256321', 'martinez.prado@mail.com', NULL, 1),
...
(70, '2022-05-14', 'Piso de 2 dormitorios con terraza', 'PISO', 116000, 62, 68, 'Calle Mendizábal Castro, nº 22 - 2ºA', 'Nerja', 'Málaga', 2, 2, NULL, 'si', 'si', NULL, NULL, NULL, 'si', 'si', NULL, 'si', 'si', 'si', 'Lucía', 'Mendoza Cardozo', '33221358W', '654258712', 'l.mendoza.cardozo@mail.com', NULL, 1),
...
(73, '2022-05-08', 'Ático de 2 dormitorios', 'ÁTICO', 205000, 106, 112, 'Avda. Mediterráneo nº 32 - 4ºA', 'Nerja', 'Málaga', 2, 2, NULL, 'si', 'si', NULL, NULL, NULL, 'si', 'si', 'si', 'si', 'si', NULL, 'Lorena', 'Montiel Pazos', '36524965H', '693258741', 'montiel.pazos@mail.com', NULL, 1);
...
--
ALTER TABLE `clientes`
  MODIFY `id_cliente` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;

--
-- AUTO_INCREMENT de la tabla `inmuebles`
--
ALTER TABLE `inmuebles`
  MODIFY `id_inmueble` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=74;
...
--
ALTER TABLE `inmuebles`
  ADD CONSTRAINT `inmuebles_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`) ON UPDATE CASCADE;
